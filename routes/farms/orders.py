...
from routes.farms.admin_farmer_dashboard.dashboard import build_dashboard_states, percent_change
from database import db_connection
from decorators.roles import admin_required, user_required
...
@orders.route("/stats/overview", methods=["GET"])
@admin_required
